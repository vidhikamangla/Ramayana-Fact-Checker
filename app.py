...
Return only the JSON. then one line explanation why the translation is true or false by also stating what part of the verse states that our translation is true.
---
